...
var r=n.response(this),o=this.context.getPromise(),u=function(t){"application/json"==this.getResponseHeader("Content-Type")&&(t=JSON.stringify(t)),this.responseText=t,setTimeout(function(){this.onload&&this.onload()}.bind(this),1)}.bind(this);r instanceof o?r.then(u.bind(this))["catch"](this.onerror.bind(this)):u(r)},o.prototype.abort=function(){i.debug("XhrMock.destroy(): Aborted")},o.prototype.getRequestHeader=function(t){return this.requestHeaders[t.toLowerCase()]},o.prototype.setResponseHeader=function(t,e){this.responseHeaders[t.toLowerCase()]=e},o.prototype.setStatus=function(t){return this.status=t,this},r.exports={Class:o,$get:function(t){return new o(t)}}}.call(e,n,e,t),!(void 0!==r&&(t.exports=r))},function(t,e,n){var r;r=function(t,e,r){"use strict";function o(){this.headers={}}var i=n(19);Object.defineProperty(o.prototype,"constructor",{value:o,enumerable:!1}),o.jsonContentType="application/json",o.multipartContentType="multipart/mixed",o.urlencodedContentType="application/x-www-form-urlencoded",o.prototype.setHeader=function(t,e){return this.headers[t.toLowerCase()]=e,this},o.prototype.getHeader=function(t){return this.headers[t.toLowerCase()]},o.prototype.hasHeader=function(t){return t.toLowerCase()in this.headers},o.prototype.setHeaders=function(t){return i.forEach(t,function(t,e){this.setHeader(e,t)}.bind(this)),this},o.prototype.isContentType=function(t){return this.getContentType().indexOf(t)>-1},o.prototype.getContentType=function(){return this.getHeader("Content-Type")||""},o.prototype.isMultipart=function(){return this.isContentType(o.multipartContentType)},o.prototype.isUrlEncoded=function(){return this.isContentType(o.urlencodedContentType)},o.prototype.isJson=function(){return this.isContentType(o.jsonContentType)},r.exports={Class:o}}.call(e,n,e,t),!(void 0!==r&&(t.exports=r))}])});
