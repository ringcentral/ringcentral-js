    ...
    describe('RCSDK.helpers.Call', function () {
        ...
        describe('createUrl', function () {
            it('returns URL depending on options', function () {
                ...
                expect(Call.createUrl({
                    active: true,
                    personal: true
                })).to.equal('/account/~/extension/~/active-calls');
        ...
        var calls = [
            {
                type: 'Voice',
                direction: 'Inbound',
                startTime: '2014-08-26T09:46:06.781Z'
            },
            {
                type: 'Voice',
                direction: 'Outbound',
                startTime: '2014-08-26T08:46:06.781Z'
            },
            {
                type: 'Voip',
                direction: 'Inbound',
                startTime: '2014-08-26T07:46:06.781Z'
            },
            {
                type: 'Voip',
                direction: 'Outbound',
                startTime: '2014-08-26T06:46:06.781Z'
            }
        ];
        describe('filter', function () {
            it('allows to filter calls by type and direction', function () {
                expect(calls.filter(Call.filter({
                    type: 'Voice',
                    direction: 'Inbound'
                })).length).to.equal(1);
                ...
                calls: [
                    {
                        ...
                        'result': 'Accepted',
                        'to': {
                            'phoneNumber': '1855COMPANY',
                            'name': 'Called Ext Name'
                        },
                        'from': {
                            'phoneNumber': '1650CALLER0',
                            'name': 'Called Ext Name',
        ...
        describe('mergeAll', function () {
            it('merges together calls from presence, active calls, calls', function () {
                var presenceCalls = Call.mergePresenceCalls([], mocks.ringing.presence), allCalls = Call.mergeAll(presenceCalls, mocks.ringing.calls, mocks.ringing.activeCalls).sort(Call.comparator()).reverse();
