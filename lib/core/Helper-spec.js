describe('RCSDK.core.Helper', function() {
    ...
    function attachSpy(suite) {
        ...
        suite.beforeEach(function() {
            Helper._createUrl = Helper.createUrl;
            Helper.createUrl = chai.spy(function(options) {
                options = options || {};
        ...
        suite.afterEach(function() {
            Helper.createUrl = Helper._createUrl;
            delete Helper._createUrl;
        });
    ...
    describe('loadRequest', function() {
        ...
        it('provides given url, if not - object.url, if not - default url', function() {
            ...
            expect(Helper.createUrl).to.be.called.once();
    ...
    describe('syncRequest', function() {
        ...
        it('sets syncType to FSync if no syncToken was given', function() {
            ...
            expect(Helper.syncRequest().get.syncType).to.equal('FSync');
        ...
        it('sets syncType to ISync if syncToken was given and deletes all other options.get', function() {
            ...
            expect(request.get.foo).to.be.an('undefined');
            expect(request.get.syncType).to.equal('ISync');
            expect(request.get.syncToken).to.equal(options.get.syncToken);
    ...
    describe('parseMultipartResponse', function() {
        ...
        it('evaluates multipart response', function() {
            ...
            expect(ajax.isResponseMultipart()).to.equal(true);
