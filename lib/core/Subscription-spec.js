    ...
    describe('RCSDK.core.Subscription', function () {
        ...
        describe('notify method', function () {
            it('decrypts AES-encrypted messages when the subscription has an encryption key', function () {
                var subscription = rcsdk.getSubscription(), nspy = spy(function (event) {
                ...
                subscription.on(subscription.events.notification, nspy).subscribeAtPubnub().notify(aesMessage);
                // Directly call notify method
