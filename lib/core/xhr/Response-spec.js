describe('RCSDK.core.xhr.Response', function() {
    ...
    describe('constructor', function() {
        ...
        it('parses headers into object', function() {
            ...
            expect(rcsdk.getResponse(null, 200, '{}', jsonResponseHeaders).isJson()).to.equal(true);
            expect(rcsdk.getResponse(null, 204, '{}', multipartResponseHeaders).isMultipart()).to.equal(true);

        });

        it('calls the success callback after parsing a good multi-part/mixed response', function() {

            var response = rcsdk.getResponse(null, 204, goodMultipartMixedResponse, multipartResponseHeaders);
        ...
        it('calls the success callback for all individual parts that are parsed (including errors)', function() {
            ...
            var response = rcsdk.getResponse(null, 204, multipartMixedResponseWithErrorPart, multipartResponseHeaders);
        ...
        it('calls the error callback if it fails to parse the parts info block', function() {
            ...
            var response = rcsdk.getResponse(null, 204, badMultipartMixedResponse, multipartResponseHeaders);
        ...
        it('calls the error callback if it is unable to parse the JSON data, passing the error object', function() {
            ...
            var response = rcsdk.getResponse(null, 200, 'THIS IS JUNK', jsonResponseHeaders);
        ...
        it('uses the error_description property of the JSON data when there is an error but no message property', function() {
            ...
            var response = rcsdk.getResponse(null, 404, '{"error_description": "ERROR"}', jsonResponseHeaders);
        ...
        it('uses the description property of the JSON data when there is an error but no message or error_description properties', function() {
            ...
            var response = rcsdk.getResponse(null, 404, '{"description": "ERROR"}', jsonResponseHeaders);
        ...
        it('parses empty response', function() {
            ...
            var response = rcsdk.getResponse(null, 204, '', jsonResponseHeaders);
