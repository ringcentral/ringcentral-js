...
var AuthGate = /** @class */ (function (_super) {
    ...
    function AuthGate() {
        ...
        _this.before = function () { return _this.setState({ authorizing: true }); };
        ...
        _this.loginUrl = function (options) { return __awaiter(_this, void 0, void 0, function () {
            var platform;
            return __generator(this, function (_a) {
                platform = this.props.sdk.platform();
                return [2 /*return*/, platform.loginUrl(options)];
            });
        }); };
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1: return [2 /*return*/, _a.apply(this, [(_b.isAuthorized = _c.sent(),
                                    _b.authorizing = false,
                                    _b.authError = authError,
                                    _b)])];
                    }
                });
            });
    ...
    AuthGate.prototype.componentWillMount = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, sdk, ensure, platform, _b, _c, e_2;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, platform.auth().accessTokenValid()];
                    case 1:
                        _b.apply(this, [(_c.isAuthorized = _d.sent(),
                                _c)]);
    ...
    AuthGate.prototype.componentWillUnmount = function () {
        var platform = this.props.sdk.platform();
    ...
    AuthGate.prototype.render = function () {
        ...
        return children(__assign({}, this.state, props, { loginUrl: this.loginUrl, parseRedirect: this.parseRedirect, logout: this.logout }));
    };
    return AuthGate;
}(react_1["default"].Component));
exports.AuthGate = AuthGate;
exports.withAuthGate = function (_a) {
    var sdk = _a.sdk, _b = _a.ensure, ensure = _b === void 0 ? false : _b;
    return function (Cmp) { return function (props) { return (<AuthGate sdk={sdk} ensure={ensure}>
        {function (renderProps) { return <Cmp {...props} {...renderProps}/>; }}
    </AuthGate>); }; };
};
