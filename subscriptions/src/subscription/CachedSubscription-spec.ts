...
describe('RingCentral.subscription.CachedSubscription', function() {
    ...
    describe('create', function() {
        ...
        it('supports legacy definition', asyncTest(sdk => {
    ...
    describe('restore', () => {
        ...
        it('sets event filters if they are not defined', asyncTest(sdk => {
            const sub = createSubscriptions(sdk);
        ...
        it('uses previous event filters if they are defined', asyncTest(sdk => {
            const sub = createSubscriptions(sdk);
            var s = sub.createCachedSubscription({cacheKey: 'foo'});
            s.restore(['bar']);
            s.restore(['foo']);
