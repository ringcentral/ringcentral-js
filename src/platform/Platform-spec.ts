...
describe('RingCentral.platform.Platform', function() {
    ...
    describe('isTokenValid', function() {
        ...
        it('is not authenticated after logout', function() {

            return getMock((sdk)=> {

                var platform = sdk.platform();

                sdk.mockRegistry().logout();
    ...
    describe('authorized', function() {
        ...
        it('initiates refresh if not authorized', function() {

            return getMock((sdk)=> {

                var platform = sdk.platform();

                sdk.mockRegistry().tokenRefresh();
        ...
        it('produces error if refresh did not happen', function() {
    ...
    describe('sendRequest', function() {
        ...
        it('tries to refresh the token if Platform returns 401 Unauthorized and re-executes the request', function() {
            ...
            return getMock((sdk)=> {
                ...
                sdk.mockRegistry()
                    .apiCall('GET', path, {message: 'time not in sync'}, 401)
                    .tokenRefresh()
    ...
    describe('refreshPolling', function() {
        ...
        it('polls the status of semaphor and resumes operation', function() {
            ...
            return getMock((sdk)=> {
                ...
                return platform['_refreshPolling'](); // calling private API
        ...
        it('resolves with error if token is not valid after releaseTimeout', function() {
            ...
            return getMock((sdk)=> {
                ...
                return platform
                    ['_refreshPolling']() // calling private API
                    .then(function() {
                        throw new Error('This should not be reached');
                    })
                    .catch(function(e) {
        ...
        it('sends request using appropriate method', function() {
            ...
            return getMock((sdk)=> {
                ...
                function test(method:string) {
                    ...
                    sdk.mockRegistry().apiCall(method, path, {foo: 'bar'});
