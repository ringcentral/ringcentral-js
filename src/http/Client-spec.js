...
describe('RingCentral.http.Client', function() {
    ...
    describe('createRequest', function() {
        ...
        it('sets default headers & properties for GET', function() {
        ...
        it('sets default headers & properties for POST', function () {
            var request = getClient().createRequest({url: 'http://foo/bar', method: 'POST', body: {foo: 'bar'}});
            expect(request.headers.get('Accept')).to.equal('application/json');
            expect(request.headers.get('Content-Type')).to.equal('application/json');
            expect(request.url).to.equal('http://foo/bar');
