...
describe('RingCentral.http.Client', function() {
    ...
    describe('createRequest', function() {
        ...
        it('sets default headers & properties for GET', asyncTest(sdk => {

            const request = sdk.platform().client().createRequest({url: 'http://foo/bar', query: {foo: 'foo'}});
        ...
        it('sets default headers & properties for POST', asyncTest(sdk => {

            const request = sdk.platform().client().createRequest({url: 'http://foo/bar', method: 'POST', body: {foo: 'bar'}});
        ...
        it('validates the method', asyncTest(sdk => {
